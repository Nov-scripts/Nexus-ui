    ...
    function self:create_tab(title: string, icon: string)
        ...
        function TabManager:create_module(settings: any)
            ...
            function ModuleManager:create_dropdown(settings: any)
                ...
                function Module:create_button(settings)
    -- settings:
    -- title (string)
    -- flag (string) -- optional, for config or reference
    -- callback (function) -- called on click

    local button = Instance.new("TextButton")
    button.Name = settings.flag or settings.title or "Button"
    button.Size = UDim2.new(1, 0, 0, 30)
    button.BackgroundColor3 = Color3.fromRGB(40, 40, 40) -- match UI style
    button.TextColor3 = Color3.fromRGB(255, 255, 255)
    button.Font = Enum.Font.GothamBold
    button.TextSize = 16
    button.Text = settings.title or "Button"
    button.AutoButtonColor = true
    button.LayoutOrder = self.layoutOrder or 1000
    button.Parent = self.container -- your module container frame

    -- ButtonManager object to match style of other elements
    local ButtonManager = {}
